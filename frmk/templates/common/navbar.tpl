	...
	<nav class="top-bar" data-topbar role="navigation">
		...
		<section class="top-bar-section">
			...
			<ul class="right">
				...
				<li class="has-dropdown">
					<a href="{$BASE_URL}pages/users/profile.php"><i class="fi-torso nav-bar-icon"></i>Profile</a>
					<ul class="dropdown">
						<li><a href="{$BASE_URL}pages/authentication/sign-in.php"><i class="fi-lock nav-bar-icon"></i>Sign out</a></li>
					</ul>
				</li>
